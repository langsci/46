...
\label{def:kategorie}
Eine Kategorie ist eine Menge linguistischer Einheiten, die alle ein bestimmtes Merkmal haben oder bei denen der Wert eines bestimmten Merkmals gleich gesetzt ist.
\index{Kategorie}
}
