...
Die Unterscheidung von Merkmalen (\zB \textsc{Kasus}) und ihren Werten (im Fall von \textsc{Kasus} Nominativ, Akkusativ usw.) erlaubt es, sprachliche Einheiten allein schon durch das Vorhandensein bzw.\ die Abwesenheit von Merkmalen in Klassen einzuteilen.
}
...
Die von einem Valenzgeber lizenzierten Einheiten (\zB Nomina in bestimmten Kasus bei bestimmten Verben) sind seine Ergänzungen.
