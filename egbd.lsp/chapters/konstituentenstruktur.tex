...
Man beschreibt zunächst die Struktur kleinerer Konstituenten (NPs, PPs usw.), aus denen dann größere Konstituenten und schließlich Sätze aufgebaut werden.
}
...
Schließlich werden in Strukturschemata Rektionsbeziehungen durch Pfeile angezeigt, und zwar durch einen durchgehenden Pfeil wie in (\ref{ex:konst1999a}) für obligatorische Rektion von Y durch X und eine gestrichelten Pfeil wie in (\ref{ex:konst1999b}) für mögliche Rektion von Y durch X.
Im vorläufigen Phrasenschema für die Präpositionalphrase in Abbildung~\ref{fig:strschembsprek} zeigt der Pfeil \zB an, dass der P-Kopf die NP obligatorisch regiert.
