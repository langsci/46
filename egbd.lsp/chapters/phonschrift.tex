...
In Abschnitt~\ref{sec:einsilblerzweisilbler} wurden entsprechende Generalisierungen zum Silbengewicht formuliert, aus denen das direkt folgt.
...
Die entsprechenden langen Silben findet man sehr häufig mit Dehnungsschreibung (\zB \textit{Knie}, \textit{Reh}, \textit{roh}).
...
Lediglich \textit{ie} ist eine nahezu obligatorische Dehnungsschreibung mit wenigen Ausnahmen (\zB \textit{Igel}).
