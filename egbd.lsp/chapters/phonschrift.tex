...
In Abschnitt~\ref{sec:gespanntheitbetonunglaenge} (besonders Tabelle~\ref{tab:vokalviereckmitgespannt} auf S.~\pageref{tab:vokalviereckmitgespannt}) wurde ein Vokalsystem vorgeschlagen, in dem sowohl dem gespannten /\textipa{E}/ als auch dem gespannten /e/ die ungespannte Variante /\textipa{\u{E}}/ zugeordnet ist.
