...
Diese Tatsache sowie semantische Besonderheiten des Perfekts (vgl.\ S.~\pageref{abs:perfektsem}) wurden gelegentlich als Argumente genommen, das Perfekt nicht als Tempus im eigentlichen Sinn zu behandeln.
Wir gehen hier darauf nicht weiter ein, weisen aber darauf hin, dass im Alltagssprachgebrauch das Präsensperfekt der primäre Ausdruck von Vergangenheitsbezug ist und deswegen hier als Tempus behandelt wird.

\Satz{Analytische Tempora und Finitheit}{
\label{satz:anatemp}
...
\label{abs:perfektsem}Während das Präteritum in (\ref{ex:prd7452b}) nur so verstanden werden kann, dass es 1993 ein punktuelles Ereignis gab, lässt das Präsensperfekt in (\ref{ex:prd7452a}) neben dieser Lesart eine zweite zu.
