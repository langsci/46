...
Ein \textit{Experiencer} ist ein Mitspieler in einer von einem Verb bezeichneten Situation, bei dem ein für die Situation spezifischer psychischer Zustand ausgelöst wird.
\index{Experiencer}
}
...
Unabhängig davon muss man annehmen, dass die Präpositionen in PP-Angaben den regierten NPs eine Rolle zuweisen, und dass der Kasus freier NP-Angaben direkter Ausdruck einer freien Rolle ist.\index{Angabe!pr{\"a}positional}
...
Beim Dativ zu \textit{schenken} in (\ref{ex:rel82913a}) und bei der \textit{an}-PP zu \textit{denken} in (\ref{ex:rel82914a}) würde man von Ergänzungen sprechen.\index{Erg{\"a}nzung}\index{Angabe}
...
\index{Erg{\"a}nzung!pr{\"a}dikativ}
...
\index{Passiv!als Valenz{\"a}nderung}
\index{Passiv!werden--}
}
...
\label{sec:ppergang}
\index{Erg{\"a}nzung!PP--}
\index{Objekt!pr{\"a}positional}

Bisher wurde viel über nominale Ergänzungen und Angaben geredet.
Aber welche PPs denn nun als Ergänzungen (also \textit{Präpositionalobjekte}) und welche als Angabe betrachtet werden sollen, ist noch offen.\index{Pr{\"a}positionalobjekt}
...
\index{Pr{\"a}sensperfekt}
\index{Pr{\"a}teritumsperfekt}
\index{Futurperfekt}
