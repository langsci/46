...
\begin{Vertiefung}{Probleme mit der Agens-Definition}
...
Es gibt zwei Arten von \textit{intransitiven Verben} (bzw. Nominativ-Dativ-Verben), nämlich \textit{Unakkusative} mit nicht-agentivem Nominativ wie \textit{platzen} und \textit{Unergative} mit agentivem Nominativ wie \textit{arbeiten}.
}
