...
Vorher wird jetzt aber ein anderes Beschreibungsmodell eingeführt, das dabei hilft, die Regularitäten des Satzbaus im Deutschen zu verdeutlichen.
...
Alternativ könnten wir Finitheit so definieren, dass Imperative zu den finiten Verbformen zählen.
Beide Lösungen haben Vor- und Nachteile, und wir legen uns nicht auf eine Lösung fest.
...
Andere Analysen sind in einem größeren theoretischen Rahmen -- für den hier kein Platz ist -- natürlich möglich.
...
Die Relativphrase kongruiert erstens mit dem Bezugsnomen in \textsc{Genus} und \textsc{Numerus}, und sie erhält zweitens ihren Wert für \textsc{Kasus} innerhalb des Relativsatzes.
...
In (\ref{ex:saetze5553a}) haben wir es mit der vielleicht komplexesten Art von Relativphrase zu tun.
