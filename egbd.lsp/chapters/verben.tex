...
\begin{table}
  \resizebox{\textwidth}{!}{
    \begin{tabular}{llll}
      ...
      Modal-- & präterito-präsentisch & Verb im reinen Infinitiv & \textit{können}, \textit{dürfen} \\
...
Hier wurde konsequent Möglichkeit (\ref{ex:schwaanalysenreduxb}) gewählt, also \textit{lach-t\cancel{e}-e-\cancel{e}n} bzw.\ \textit{lach-t-e-n} als Analyse der 1.\ und 3.\ Person Präteritum Konjunktiv gewählt wurde.
