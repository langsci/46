...
\index{Pr{\"a}teritumsperfekt!Bedeutung}
...
\end{table}
\index{Pr{\"a}sens}\index{Pr{\"a}teritum}\index{Perfekt}\index{Pr{\"a}teritumsperfekt}\index{Futur}
...
\index{Verb!schwach}
\index{Verb!Pr{\"a}sens}\index{Verb!Pr{\"a}teritum}\index{Verb!Indikativ}
...
\index{Verb!schwach}
\index{Pr{\"a}sens}\index{Pr{\"a}teritum}\index{Verb!Konjunktiv}
...
\index{Verb!Pr{\"a}fix-- vs.\ Partikel--}
...
\footnote{Flektierbare Wörter nennt man \textit{defektiv}, wenn von ihnen nicht alle theoretisch möglichen Formen gebildet werden können.\index{Defektivit{\"a}t}}
...
\index{Verb!Flexion!unregelm{\"a}ßig}
\index{Verb!St{\"a}rke}
...
Darüberhinaus gibt es Verben wie \textit{sein}, das stark \textit{suppletiv} gebildet wird, also mehrere vollständig unterschiedliche Stämme hat und damit tatsächlich \textit{unregelmäßig} ist.\label{abs:suppletiv}\index{Suppletivit{\"a}t}
