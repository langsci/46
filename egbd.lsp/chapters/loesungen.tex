...
Wie in Kapitel \ref{sec:nomina} (Abschnitt~\ref{sec:kasus}) und Kapitel~\ref{sec:relationenpraedikate} (Abschnitt~\ref{sec:semantischerollen}) dargelegt wird, sind solche Generalisierungen besonders für die strukturellen Kasus Nominativ und Akkusativ nicht zielführend.
