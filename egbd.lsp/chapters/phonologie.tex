...
\begin{exe}
  ...
  \begin{xlist}
    ...
    \ex{\label{ex:phol6726b} /\textipa{bad@s}/ \phopro \textipa{[b:a.d@s]}}
...
Aufbauend auf der Beschreibung der einzelnen Segmente kann und sollte beschrieben werden, wie diese Segmente zu größeren Einheiten zusammengesetzt werden, wie also \textit{phonologische Struktur} aufgebaut wird (zum Strukturbegriff vgl.\ Abschnitt~\ref{sec:strukturbildung}).
...
\begin{exe}
  ...
  \begin{xlist}
  	...
  	\ex{\label{ex:phol0800009003b} /\textipa{Sn\u{a}ps}/ $\Rightarrow$ \textipa{[Snap+s]} (\textit{Schnaps})}
