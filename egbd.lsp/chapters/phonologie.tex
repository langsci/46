...
Man kann \textipa{[N]} auch in diesen Fällen phonologisch auf eine Folge von \textipa{[n]} und \textipa{[g]} zurückführen (s.\ Abschnitt~\ref{sec:systematikderraender}).
...
Die in Gruppen angeordneten, mit Komma getrennten Segmente stellen jeweils verschiedene Möglichkeiten dar.
...
Es wird sofort deutlich, dass die Kombinationsmöglichkeiten sehr stark auf die Verbindung von Plosiv oder labio-dentalem Frikativ (/f/ und /v/) mit folgendem Liquid eingeschränkt sind.
