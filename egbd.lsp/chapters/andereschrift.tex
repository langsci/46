...
\footnote{Diese Aussage beruht auf einer heimlich unterstellten Trennung zwischen dem hier gar nicht behandelten \textit{Bindestrich} (-) und \textit{Gedankenstrich} (--).
Typographisch ist die Lage der beiden Striche leicht verschieden.
Außerdem ist der Gedankenstrich zumindest Druckerzeugnissen länger und hat üblicherweise auch eine feinere Strichstärke.
