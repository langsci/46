...
Dieser Prozess wird \textit{Univerbierung} genannt.\index{Univerbierung}
...
Die Normierung setzt hier viel zu spät an, wenn sie sich nur auf die Schreibung bezieht.
...
Morphosyntaktische \textit{Univerbierung} wirkt sich auf die Getrennt- und Zusammenschreibung aus.
...
Ehemalige Substantive, die ihren Status als Substantiv verlieren, können kleingeschrieben werden.
Eigennamen sind vor allem dadurch gekennzeichnet, dass sie genau ein bestimmtes Objekt in der Welt bezeichnen.
Buchstaben-Abkürzungen wie \textit{LKW}, die komplett in Majuskeln geschrieben werden, sind keine einfachen Abkürzungen, sondern Kurzwörter mit eigenen grammatischen Eigenschaften. 
...
Konstantschreibungen sichern die Wiedererkennbarkeit von Stämmen bei Flexions- und Wortbildungsprozessen.
}
