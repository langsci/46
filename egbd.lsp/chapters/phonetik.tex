...
Die Beziehung zwischen der Aussprache (\textit{Phonetik}) und der Schreibung (\textit{Graphematik} bzw.\ \textit{Graphematik}) ist kompliziert und muss gesondert diskutiert werden.
