...
\begin{exe}
  \ex{\label{ex:phot919192} \textsc{Art}: \textit{plos}, \textit{frik}, \textit{affr}, \textit{nas}, \textit{appr}, \textit{vok}}
\end{exe}
...
Man kann das Merkmalsinventar erweitern, um Oberklassen abzubilden.
