...
Adjektive können dieselbe, aber eben auch andere Positionen im Satz einnehmen wie Adkopulas, vgl.\ (\ref{ex:wa0815}) und (\ref{ex:wa0816}).
Den Adkopulas fehlt damit jegliche Flektierbarkeit, was der Grund für die hier vertretene Einordnung als eigene Klasse und eben nicht als Adjektiv ist.
...
\WFiltTree{Adkopula}{wfilt:advkopulaele}{Partikel}{Tritt das Wort prototypisch mit einem Kopulaverb auf?}{Adkopula}{anderes}
