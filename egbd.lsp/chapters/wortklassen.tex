...
Dieses Vorgehen hat später immer wieder zur Folge, dass wir Generalisierungen effizient und elegant bezüglich ganzer Wortklassen beschreiben und alle Abweichungen oder Verfeinerungen, die sich für einzelne Wörter ergeben, als Ausnahme behandeln können.
...
Kongruenz ist laut Abschnitt~\ref{sec:rektionkongruenz} eine Übereinstimmung der Werte von Merkmalen.

\textbf{?? HIER WEITER}

Die Beispiele in (\ref{ex:wk01011}) und (\ref{ex:wk01012}) illustrieren die Flektierbarkeit.
...
Artikelwörter und Adjektive kongruieren (vgl.\ Abschnitt~\ref{sec:rektionkongruenz}) mit dem Substantiv in ihrem Genus.
...
Kein andere Art von nicht-flektierbaren Wörtern verhält sich so.
...
Es ist zu definieren, was ein Vorfeldbesetzer sein soll.\index{Vorfeld}
