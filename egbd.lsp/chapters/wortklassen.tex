...
\Definition{Morphologie (Versuch)}{%
...
\Satz{Wortklassifikation nach syntaktischer Verteilung}{%
...
Wenn wir es auf die Spitze treiben würden, könnten wir sicherlich einige hundert Wortklassen definieren, da sich Wörter (genau betrachtet) oft individuell verhalten.
...
Das zugrundeliegende Konzept eines flektierbaren Wortes ist normalerweise nicht, dass es ein \textsc{Numerus}-Merkmal hat, sondern dass es paradigmatische Änderungen seiner Werte erfährt, und zwar bis auf wenige Ausnahmen in Verbindung mit Änderungen seiner Form.\index{Numerus}
...
Ein \textit{Nebensatz} ist eine syntaktische Struktur, die ein finites Verb enthält, das an letzter Stelle steht, innerhalb derer typischerweise alle Ergänzungen und Angaben dieses Verbes enthalten sind.
...
\begin{exe}
  ...
  \begin{xlist}
    ...
    \ex[*]{\label{ex:wa2829d}Doch ist das aber nicht das Ende der Saison.\label{ex:wa2829d}}
...
Bei den Satzäquivalenten handelt es sich um eine Klasse, die eher für gesprochene Sprache -- zumindest aber für dialogische Sprache -- typisch ist.
...
\Zusammenfassung{
  ...
  Nomen ist ein Oberbegriff für Substantive, Adjektive, Artikel und Pronomina.
