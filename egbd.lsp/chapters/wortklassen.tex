...
Es wäre nun denkbar, zunächst die Ebene der Wortbestandteile (als Morphologie) wie in Definition~\ref{def:morphologieversuch} zu definieren, um dann darauf aufzubauen.
...
Bei den Satzäquivalenten (Filter~\ref{wfilt:satzaeq}) handelt es sich um eine Klasse, die eher für gesprochene Sprache -- zumindest aber für dialogische Sprache -- typisch ist.
