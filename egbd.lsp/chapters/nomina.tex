...
\Zusammenfassung{
  ...
  Kasus lassen sich in einer \textit{Hierarchie} anordnen, je nachdem wie stark sie einen eigenständige semantischen Beitrag leisten (\textit{oblik}) bzw.\ nur Rektionsanforderungen erfüllen (\textit{strukturell}).
}
