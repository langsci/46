...
Ein Wort hat \textit{Artikelfunktion}, wenn es in der NP vor dem Substantiv und allen Adjektiven steht und mit diesen in Kasus und Numerus kongruiert.
...
\Satz{Wortklassen Flexion bei Pronomina und Artikeln}{\label{satz:pronflexwklassmap}%
\vspace{-0.8cm}
\begin{enumerate}\Lf
...
Viele, aber nicht alle Adjektive können in einer weiteren Position auftreten, nämlich \textit{prädikativ}.\index{Adjektiv!pr{\"a}dikativ}%
