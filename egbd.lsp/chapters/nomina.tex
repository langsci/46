...
Eine semantische Funktion haben \zB bestimmte Dative, die oft als \textit{freie Dative} (also nicht regierte Dative bzw.\ Dativangaben) bezeichnet werden.%
...
\begin{figure}
  ...
  \Treek[2]{4}{
    ...
    & \K{Gen Sg?}\QQw\DLqQ_{\textnormal{\textit{-(e)n}}}\DRqQ^{\textnormal{\textit{-(e)s}}} && \K{\textbf{Fem}}\Below{(S4)} \\
    \K{\textbf{schwach}}\Below{(S1)} && \K{Nom Pl?}\QQw\DRqQ^{\textnormal{\textit{-(e)n}}}\DLqQ_{\textnormal{\textit{\char`~e\slash-e}}}^{\textnormal{\textit{\char`~er}}} && \\
