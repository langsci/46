...
Die Zahlen 1, 2 und 3 unter den Verben führen dabei eine in der germanistischen Linguistik übliche Art und Weise ein, über die Reihenfolge und die Rektionsabhängigkeiten der Verben im Verbalkomplex zu sprechen.
...
Die Reihenfolge, in der die Zahlen stehen, entspricht der linearen Abfolge (und eben nicht der Rektionshierarchie) der Elemente im Verbalkomplex.
Ein sogenannter \textit{321-Komplex} ist typischerweise ein Verbalkomplex wie in (\ref{ex:auxinfc}).
